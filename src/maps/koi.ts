...
const objects: Placement[] = [
  ...
  // plaza props — modeled supply crates (ground clusters, no ugly cubes)
  { type: "crate", at: [-3, 0, -17], rot: 12 },
  { type: "crate", at: [-4.6, 0, -16.1], rot: -40 },
  { type: "crate", at: [-3.2, 0, -15.2], rot: 70 },
  { type: "crate", at: [4, 0, 17.5], rot: -18 },
  { type: "crate", at: [5.7, 0, 16.7], rot: 55 },
  { type: "crate", at: [26.5, 0, -17], rot: 25 },
  { type: "crate", at: [-26.5, 0, 17], rot: -30 },
  { type: "toolbox", at: [-4.2, 0, -17.6], rot: 20 },
  { type: "toolbox", at: [5.2, 0, 18.3], rot: -50 },
  // desert quiver trees + boulders breaking up the corners
  { type: "dtree", at: [-27, 0, 18.5], params: { scale: 1.2 } },
  { type: "dtree", at: [27, 0, -18.5], params: { scale: 1.0 } },
  { type: "dtree", at: [-4, 0, -19], params: { scale: 0.9 } },
  { type: "boulder", at: [26, 0, -19.5], params: { scale: 0.55 } },
  { type: "boulder", at: [-25.5, 0, 19.5], params: { scale: 0.5 } },
...
export const KOI: MapDef = {
  ...
  env: {
    ...
    fog: { color: [0.82, 0.76, 0.64], start: 45, end: 160 },
    ambient: { color: [0.58, 0.6, 0.68], intensity: 0.66, specular: 0.9 },
    sun: { rot: [-52, -38, 0], color: [1.4, 1.24, 0.98], strength: 0.85 },
    water: [0, 0.4, 0],
  },
  textures: { wall: "koi_wall", stone: "koi_stone", floor: "koi_floor" },
  brushes,
  objects,
  spawns,
  pickups,
